...
function create_house()
{
   // document.getElementById("ptxt1").innerHTML=hstr;
    ...
    //阴影
    //////////////////////////////////////////////////////////////////////////////////////
    // var geometry = new THREE.BoxGeometry( 1600, 1600, 1 );
    // var object = new THREE.Mesh( geometry, new THREE.MeshLambertMaterial( { color:0xC1C1C1 } ) );
        ...
        for(var i=0;i<archi_door.length;i++)
        {
            ...
            for(var j=0; j<aux_polyline.length; j++)
            {
                if(archi_door[i].id == aux_polyline[j].id)
                {
                    ...
                    door_scale.castShadow = true;
                    door_scale.receiveShadow = true;
