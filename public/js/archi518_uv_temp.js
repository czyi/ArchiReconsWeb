        ...
        for(var i=0;i<archi_wall.length;i++)
        {
            ...
            for(var j=0; j<aux_polyline.length; j++)
            {
                if(archi_wall[i].id == aux_polyline[j].id)
                {
                    ...
                    var top = [new THREE.Vector2((startp+width)/uvsize, height/uvsize), new THREE.Vector2(startp/uvsize, height/uvsize), 
                               new THREE.Vector2(startp/uvsize, (height+thickness)/uvsize), new THREE.Vector2((startp+width)/uvsize, (height+thickness)/uvsize)];
                    var bottom = [new THREE.Vector2((startp+width)/uvsize, (height*2+thickness)/uvsize), new THREE.Vector2(startp/uvsize, (height*2+thickness)/uvsize), 
                                  new THREE.Vector2(startp/uvsize, (height+thickness)*2/uvsize), new THREE.Vector2((startp+width)/uvsize, (height+thickness)*2/uvsize)];
                    ...
                    wall.faceVertexUvs[0][10] = [ back[3], back[0], back[2] ];
                    wall.faceVertexUvs[0][11] = [ back[0], back[1], back[2] ];
        ...
        for(var i=0;i<archi_window.length;i++)
        {
            ...
            for(var j=0; j<aux_polyline.length; j++)
            {
                if(archi_window[i].id == aux_polyline[j].id)
                {
                    ...
                    var back = [new THREE.Vector2(startp/uvsize, (altitude+thickness)/uvsize), 
                                ...
                                new THREE.Vector2(startp/uvsize, (altitude*2+thickness)/uvsize)];
                    ...
                    var right = [new THREE.Vector2((startp+width)/uvsize, 0), 
                                ...
                                new THREE.Vector2((startp+width)/uvsize, 0), altitude/uvsize];
                    var top = [new THREE.Vector2((startp+width)/uvsize, altitude/uvsize), 
                               new THREE.Vector2(startp/uvsize, altitude/uvsize), 
                               new THREE.Vector2(startp/uvsize, (altitude+thickness)/uvsize), 
                               new THREE.Vector2((startp+width)/uvsize, (altitude+thickness)/uvsize)];
                    var bottom = [new THREE.Vector2((startp+width)/uvsize, (altitude*2+thickness)/uvsize), 
                                  new THREE.Vector2(startp/uvsize, (altitude*2+thickness)/uvsize), 
                    ...
                    wall_down.faceVertexUvs[0][10] = [ back[3], back[0], back[2] ];
                    wall_down.faceVertexUvs[0][11] = [ back[0], back[1], back[2] ];


                    var up_height=wall_height-altitude;
                    ...
                    right = [new THREE.Vector2((startp+width)/uvsize, (wall_height-up_height)/uvsize), 
                             ...
                             new THREE.Vector2((startp+width)/uvsize, wall_height/uvsize)];
                    top = [new THREE.Vector2((startp+width)/uvsize, wall_height/uvsize), 
                           new THREE.Vector2(startp/uvsize, wall_height/uvsize), 
                           new THREE.Vector2(startp/uvsize, (wall_height+thickness)/uvsize), 
                           new THREE.Vector2((startp+width)/uvsize, (wall_height+thickness)/uvsize)];
                    bottom = [new THREE.Vector2((startp+width)/uvsize, (up_height+wall_height+thickness)/uvsize), 
                              new THREE.Vector2(startp/uvsize, (up_height+wall_height+thickness)/uvsize), 
                    ...
                    wall_up.faceVertexUvs[0][10] = [ back[3], back[0], back[2] ];
                    wall_up.faceVertexUvs[0][11] = [ back[0], back[1], back[2] ];
...
function initObject(){
    ...
    texture_wall = new THREE.TextureLoader().load("textures/wall/wall_0.png" );
    texture_wall.wrapS = THREE.RepeatWrapping;
    texture_wall.wrapT = THREE.RepeatWrapping;
    texture_wall.repeat.set( 10, 10 );

    texture_floor = new THREE.TextureLoader().load("textures/floor/ground_0.png" );
...
function test(){
    ...
    var cube = new THREE.CubeGeometry(500, 300, 50);
    var mesh_cube = new THREE.Mesh( cube,material_cube );
    mesh_cube.position.y=150;
    mesh_cube.position.z=200; 

    curhouse.add(mesh_cube);
    

    var texture = new THREE.ImageUtils.loadTexture('textures/wall/test.png');
    ...
    var geometry = new THREE.CubeGeometry( 500, 300, 50); 
    
    var material = new THREE.MeshPhongMaterial( { map: texture} );
  
    var front = [new THREE.Vector2(0.05, 0.35), new THREE.Vector2(0.55, 0.35), new THREE.Vector2(0.55, 0.65), new THREE.Vector2(0.05, 0.65)];
    var back = [new THREE.Vector2(0.05, 0), new THREE.Vector2(0.55, 0), new THREE.Vector2(0.55, 0.3), new THREE.Vector2(0.05, 0.3)];
    var left = [new THREE.Vector2(0, 0.35), new THREE.Vector2(0.05, 0.35), new THREE.Vector2(0.05, 0.65), new THREE.Vector2(0, 0.65)];
    var right = [new THREE.Vector2(0.55, 0.35), new THREE.Vector2(0.6, 0.35), new THREE.Vector2(0.6, 0.65), new THREE.Vector2(0.55, 0.65)];
    var top = [new THREE.Vector2(0.05, 0.65), new THREE.Vector2(0.55, 0.65), new THREE.Vector2(0.55, 0.7), new THREE.Vector2(0.05, 0.7)];
    var bottom = [new THREE.Vector2(.05, 0.3), new THREE.Vector2(0.55, 0.3), new THREE.Vector2(0.55, .35), new THREE.Vector2(.05, .35)];

    geometry.faceVertexUvs[0] = [];
    
    geometry.faceVertexUvs[0][0] = [ right[3], right[0], right[2] ];
    geometry.faceVertexUvs[0][1] = [ right[0], right[1], right[2] ];
    
    geometry.faceVertexUvs[0][2] = [ left[3], left[0], left[2] ];
    geometry.faceVertexUvs[0][3] = [ left[0], left[1], left[2] ];
    ...
    geometry.faceVertexUvs[0][8] = [ front[3], front[0], front[2] ];
    geometry.faceVertexUvs[0][9] = [ front[0], front[1], front[2] ];
    
    geometry.faceVertexUvs[0][10] = [ back[3], back[0], back[2] ];
    geometry.faceVertexUvs[0][11] = [ back[0], back[1], back[2] ];
    ...
    var material1 = new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('images/texture-atlas.jpg') } );
    ...
    geometry1.faceVertexUvs[0][0] = [ bricks[0], bricks[1], bricks[3] ];
    geometry1.faceVertexUvs[0][1] = [ bricks[1], bricks[2], bricks[3] ];
    
    geometry1.faceVertexUvs[0][2] = [ clouds[0], clouds[1], clouds[3] ];
    geometry1.faceVertexUvs[0][3] = [ clouds[1], clouds[2], clouds[3] ];
    
    geometry1.faceVertexUvs[0][4] = [ crate[0], crate[1], crate[3] ];
    geometry1.faceVertexUvs[0][5] = [ crate[1], crate[2], crate[3] ];
    
    geometry1.faceVertexUvs[0][6] = [ stone[0], stone[1], stone[3] ];
    geometry1.faceVertexUvs[0][7] = [ stone[1], stone[2], stone[3] ];
    
    geometry1.faceVertexUvs[0][8] = [ water[0], water[1], water[3] ];
    geometry1.faceVertexUvs[0][9] = [ water[1], water[2], water[3] ];
    
    geometry1.faceVertexUvs[0][10] = [ wood[0], wood[1], wood[3] ];
    geometry1.faceVertexUvs[0][11] = [ wood[1], wood[2], wood[3] ];
