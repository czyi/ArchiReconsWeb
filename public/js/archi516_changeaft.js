...
function get_fur_inner(x, name){
    ...
    //   </h4>
    // </div>
    // <div id="collapseFur-1" class="panel-collapse collapse in">
    ...
    //         </p>                                    
    //       </div>
    //       <button type="button" class="btn btn-default fur-del-bt" onclick="delete_fur(0);">删除</button>
    //   </div>
    // </div>
...
function delete_fur(num){
    ...
    document.getElementById("ptxt1").innerHTML="id:"+allfur.childNodes[1].getAttribute("id");
}
